  ...
  import VueRadio from './radio.js'
  import BracketsLeft from './brackets-left.js'
  import BracketsRight from './brackets-right.js'
  ...
  export default {
    ...
    :class="{
      ...
      'is-mouseover__dark': $vuetify.theme.dark && isMouseover,
